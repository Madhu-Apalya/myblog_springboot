...
public class PostController {
    ...
    public String createNewPost(@Valid Post post, @RequestParam("file") MultipartFile file,
        ...
        if (bindingResult.hasErrors()) {
            ...
            post.setContent(contentType);
			//post.setImage(bytes);
            post.setImage(new String(Base64Utils.encode(bytes)));
